...
- Name: playground.spec.js >> Playground - Employee Table >> should add new employee
- Location: tests/playground.spec.js:66:3
...
Call log:
  - waiting for locator('[data-testid="add-employee-btn"]')
    - locator resolved to <button type="submit" class="btn btn-success" data-testid="add-employee-btn">+ Add Employee</button>
