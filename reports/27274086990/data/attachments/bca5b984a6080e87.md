...
- Name: playground.spec.js >> Playground - Employee Table >> should delete employee
- Location: tests/playground.spec.js:75:3
...
Locator:  locator('[data-testid="employee-row-1"]')
Expected: visible
Received: hidden
Timeout:  15000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="employee-row-1"]')
    34 × locator resolved to <tr data-testid="employee-row-1">…</tr>
