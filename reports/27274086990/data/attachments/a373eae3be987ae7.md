...
- Name: playground.spec.js >> Playground - Modal >> should close modal by clicking overlay
- Location: tests/playground.spec.js:138:3
...
Call log:
  - waiting for locator('[data-testid="open-modal-btn"]')
