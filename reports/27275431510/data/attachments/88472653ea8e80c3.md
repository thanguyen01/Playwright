...
- Name: playground.spec.js >> Playground - Employee Table >> should search employees
- Location: tests/playground.spec.js:83:3
...
Call log:
  - waiting for locator('[data-testid="search-input"]')
    - locator resolved to <input type="text" id="search-input" data-testid="search-input" placeholder="Search employees..."/>
    - fill("Jane")
  - attempting fill action
    ...
    - retrying fill action
      - waiting 100ms
    249 × waiting for element to be visible, enabled and editable
        - element is not visible
      - retrying fill action
        - waiting 500ms
